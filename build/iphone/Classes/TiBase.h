...
// in simulator we redefine to format for SQLite Developer console
...
{\
	NSString * exceptionName = [@"org.sqlite." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sqlite";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISQLiteNativeItemNone = -1, 
	UISQLiteNativeItemSpinner = -2,
	UISQLiteNativeItemProgressBar = -3,
	
	UISQLiteNativeItemSlider = -4,
	UISQLiteNativeItemSwitch = -5,
	UISQLiteNativeItemMultiButton = -6,
	UISQLiteNativeItemSegmented = -7,
	
	UISQLiteNativeItemTextView = -8,
	UISQLiteNativeItemTextField = -9,
	UISQLiteNativeItemSearchBar = -10,
	
	UISQLiteNativeItemPicker = -11,
	UISQLiteNativeItemDatePicker = -12,
	
	UISQLiteNativeItemInfoLight = -13,
	UISQLiteNativeItemInfoDark = -14,
	
	UISQLiteNativeItemDisclosure = -15,
	
	UISQLiteNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SQLite instances of
