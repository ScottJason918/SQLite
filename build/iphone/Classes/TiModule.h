...
/**
 The base class for all SQLite modules
 */
...
/**
 SQLite Platform calls this method on startup.
 */
-(void)startup;

/**
 SQLite Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SQLite Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SQLite Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 SQLite Platform calls this method on resume.
 @param sender The sender of the event.
 */
